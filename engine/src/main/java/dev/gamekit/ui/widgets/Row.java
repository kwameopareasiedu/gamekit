...
public class Row extends Flex {
  public Row(String key, RowConfig config, Widget... children) {
    super(key, config, children);
  }

  public static Row create(String key, RowConfig.Updater updater, Widget... children) {
    return new Row(key, Widgets.configureRow(updater), children);
  }

  public static Row create(RowConfig.Updater updater, Widget... children) {
    return new Row(null, Widgets.configureRow(updater), children);
  }

  public static Row create(String key, Widget... children) {
    return Row.create(key, props -> { }, children);
  }
