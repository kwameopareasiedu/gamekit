...
|----------|---------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Parent   | Widgets which nest one or more widgets within them. They are used for layout and _usually_ don't have a visual appearance | [Row](widgets/row.md), [Column](widgets/column.md), [Stack](widgets/stack.md), [Scaled](widgets/scaled.md), [Padding](widgets/padding.md), [Align](widgets/align.md), [Sized](widgets/sized.md), [Theme](widgets/theme.md), [Panel](widgets/panel.md), [Opacity](widgets/opacity.md), [Button](widgets/button.md), [Checkbox](widgets/checkbox.md), [Compose](widgets/compose.md), [Builder](widgets/builder.md), [Stateful](widgets/stateful.md) |
| Leaf     | Widgets which don't nest other widgets and have visual representations                                                    | [Text](widgets/text.md), [Field](widgets/field.md), [Image](widgets/image.md), [Progress](widgets/progress.md), [Slider](widgets/slider.md), [Gap](widgets/gap.md), [Empty](widgets/empty.md)                                                                                                                                                                                                                                                     |
